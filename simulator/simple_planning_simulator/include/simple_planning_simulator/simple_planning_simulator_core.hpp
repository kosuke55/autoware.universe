...
private:
  ...
  bool enable_pub_steer_ =
    true;  //!< @brief flag to publish steering report. if false, it is expected to be converted and
           //!< published from actuation_status in other nodes (e.g. raw_vehicle_cmd_converter)
