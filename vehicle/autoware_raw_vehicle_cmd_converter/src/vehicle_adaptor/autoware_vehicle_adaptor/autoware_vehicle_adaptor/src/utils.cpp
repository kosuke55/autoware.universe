...
///////////////// VehicleAdaptor ///////////////////////
  ...
  {
    get_initial_hidden_.set_initial_hidden_params(
      ...
      weight_initial_hidden_final_layer, weight_initial_hidden_fusion_layer, weight_initial_hidden_only_online,
      ...
      h_gru_dim_for_initial_hidden_ = weight_initial_hidden_gru_hh.cols();
      use_nonzero_initial_hidden_ = true;
  }
  void VehicleAdaptor::set_initial_hidden_params_from_csv(std::string csv_dir){
    ...
    Eigen::MatrixXd weight_initial_hidden_fusion_layer = read_csv(csv_dir + "/weight_initial_hidden_fusion_layer.csv");
    Eigen::MatrixXd weight_initial_hidden_only_online = read_csv(csv_dir + "/weight_initial_hidden_only_online.csv");
    ...
    Eigen::VectorXd bias_initial_hidden_fusion_layer = read_csv(csv_dir + "/bias_initial_hidden_fusion_layer.csv").col(0);
    Eigen::VectorXd bias_initial_hidden_only_online = read_csv(csv_dir + "/bias_initial_hidden_only_online.csv").col(0);
    set_initial_hidden_params(
      weight_initial_hidden_acc_layer_1, weight_initial_hidden_steer_layer_1,
      weight_initial_hidden_acc_layer_2, weight_initial_hidden_steer_layer_2,
      weight_initial_hidden_gru_ih, weight_initial_hidden_gru_hh,
      weight_initial_hidden_final_layer, weight_initial_hidden_fusion_layer, weight_initial_hidden_only_online,
    ...
    double time_stamp, const Eigen::VectorXd & states, const double acc_controller_input, const double steer_controller_input)
  {
    ...
    if (use_nonzero_initial_hidden_)
    {
      ...
      for (int i = 0; i<update_lstm_len_; i++) {
        ...
        get_initial_hidden_.update_gru(NN_input, h_gru, h_gru_next);
        h_gru = h_gru_next;
      }

      Eigen::VectorXd initial_hidden = get_initial_hidden_.get_initial_hidden(h_gru);
