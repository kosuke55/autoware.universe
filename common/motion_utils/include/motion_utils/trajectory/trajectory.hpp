  ...
  if (is_driving_forward) {
    for (size_t i = 0; i < points.size() - 1; ++i) {
      ...
      if (i == points.size() - 2) {
        ...
        tier4_autoware_utils::getPose(points.at(i + 1)).orientation =
          tier4_autoware_utils::getPose(points.at(i)).orientation;
      }
    }
  } else {
    ...
    tier4_autoware_utils::getPose(points.at(0)).orientation =
      tier4_autoware_utils::getPose(points.at(1)).orientation;
  }
}
